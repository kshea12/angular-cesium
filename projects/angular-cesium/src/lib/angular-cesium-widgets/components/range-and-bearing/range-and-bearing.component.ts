        ...
        return (update.editMode === EditModes.CREATE && update.editAction !== EditActions.ADD_LAST_POINT
          ...
          (labels, position, index, array) => {
            if (index !== 0) {
              ...
              const distance = CesiumCartesian3.distance(previousPosition, position) / 1000;
              labels.push(
                {
                  text:
                  ...
                  scale: 0.2,
                  font: '80px Helvetica',
                  pixelOffset: new CesiumCartesian2(-20, -8),
                  position: new CesiumCartesian3(
                ...
                },
                {
                  ...
                  scale: 0.2,
                  font: '80px Helvetica',
                  pixelOffset: new CesiumCartesian2(-35, -8),
                  position: position,
                  fillColor: Color.WHITE,
                  outlineColor: Color.WHITE,
                  showBackground: true,
